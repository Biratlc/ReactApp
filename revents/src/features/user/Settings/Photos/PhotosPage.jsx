...
import {uploadProfileImage, deletePhoto, setProfilePicture} from '../../userActions';
...
const PhotosPage = ({uploadProfileImage, photos, profile, deletePhoto, setProfilePicture, loading}) => {
  ...
  return (
    <Segment>
      <Header dividing size="medium" content="Upload an image and set it as your profile picture" />
      <Grid>
        <Grid.Row />
        <Grid.Column width={4}>
