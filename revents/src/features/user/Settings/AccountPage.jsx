...
const validate = combineValidators({
    newPassword: isRequired({message: 'Please enter a password'}),
    confirmNewPassword: composeValidators(
        isRequired({message: 'Please confimr your new password'}),
        matchesField('newPassword')({message: 'Passwords do not match'})
    )()
})
